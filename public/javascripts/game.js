...
Game.prototype.addNewSquare = function () {
  this.currentPiece = new Square(225, 0, this.colorOption[Math.floor(Math.random()*4)]); //"150" to have the currentPiece fall from the middle
      ...
      if(this.currentPiece.x === this.viruses[i].x){
        if(this.currentPiece.y === this.viruses[i].y - 25){
          if(this.currentPiece.color === this.viruses[i].color){ //if both square matches
            this.currentPiece.color = "#416788"; //replace color of currentPiece to canvas color
            this.viruses[i].color = "#416788";  //replace color of virus to canvas color
            this.soundEffect();
      ...
      if(this.currentPiece.x === this.unmatched[i].x){
        if(this.currentPiece.y === this.unmatched[i].y - 25){
          if(this.currentPiece.color === this.unmatched[i].color){
            this.currentPiece.color = "#416788";
            this.unmatched[i].color = "#416788";
